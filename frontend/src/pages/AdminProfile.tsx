          ...
          <aside className="lg:col-span-1 lg:sticky lg:top-24 space-y-8">
            <Card className="bg-white/70 backdrop-blur-sm border-zinc-200/60 shadow-sm">
              ...
              <CardContent className="space-y-4">
                <InfoRow icon={User} label="Full Name" value={profile.fullName} isEditing={isEditing} onChange={(e) => setProfile({...profile, fullName: e.target.value})}/>
                <InfoRow icon={Mail} label="Email" value={profile.email} isEditing={isEditing} onChange={(e) => setProfile({...profile, email: e.target.value})} type="email"/>
                <InfoRow icon={Phone} label="Phone" value={profile.phonenumber} isEditing={isEditing} onChange={(e) => setProfile({...profile, phonenumber: e.target.value})}/>
                <InfoRow icon={Briefcase} label="Department" value={profile.department} isEditing={isEditing} onChange={(e) => setProfile({...profile, department: e.target.value})}/>
              </CardContent>
            </Card>
